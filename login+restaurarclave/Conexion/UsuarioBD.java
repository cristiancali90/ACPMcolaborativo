    ...
    public void crearUsuario(Usuario u) {
        try {
            String sql1 = "Insert into tbusuario"
                    + "(idRoles, Cargo, Primer_Nombre, Segundo_Nombre, Primer_Apellido, Segundo_Apellido, Cedula, Telefono, Correo, Usuario, Contrasena, Pregunta, Respuesta, Dependencia, Estado)"
                    + "VALUES ('" + u.getRol() + "', '" + u.getCargo() + "', '" + u.getPrimer_Nombre() + "', '" + u.getSegundo_Nombre() + "', '" + u.getPrimer_Apellido() + "', '" + u.getSegundo_Apellido() + "', '" + u.getCedula() + "', '" + u.getTelefono() + "', '" + u.getCorreoElectronico() + "','" + u.getUsuario() + "', '" + u.getContrasena() + "', '" + u.getPregunta() + "', '" + u.getRespuestas() + "', '" + u.getDependencia() + "','" + u.isEstado() + "')";
